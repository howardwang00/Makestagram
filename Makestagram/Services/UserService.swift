...
struct UserService {
    static func create(_ firUser: FIRUser, username: String, completion: @escaping (User?) -> Void) {
        ...
        let ref = Database.database().reference().child(Constants.users).child(firUser.uid)
    ...
    static func posts(for user: User, completion: @escaping ([Post]) -> Void) {
        let ref = Database.database().reference().child(Constants.posts).child(user.uid)
    ...
    static func followers(for user: User, completion: @escaping ([String]) -> Void) {
        let followersRef = Database.database().reference().child(Constants.Follow.followers).child(user.uid)
